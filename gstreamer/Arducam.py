# Copied from: https://github.com/ArduCAM/PICO_SPI_CAM/blob/master/Python/Arducam.py
...
class ArducamClass(object):
    def __init__(self,Type):
        ...
        self.SPI_CS=digitalio.DigitalInOut(board.SPI_CSB)
        self.SPI_CS.direction = digitalio.Direction.OUTPUT
        self.I2cAddress=0x30
        self.spi = busio.SPI(clock=board.SPI_CLK, MOSI=board.SPI_MO, MISO=board.SPI_MI)
        while not self.spi.try_lock():
            pass
        self.spi.configure(baudrate=8000000,polarity=0,phase=0,bits=8)
        self.i2c = busio.I2C(scl=board.I2C1_SCL, sda=board.I2C1_SDA,frequency=1000000)
